...
alias gbre='git branch | grep "eric/"'
alias gbrey='git branch | grep "eric/" | yank'
alias gbry='git branch | yank'
...
alias gf='git fetch'
alias gl='git log'
alias glo='git log --pretty=format:"%C(bold blue)%h%Creset %C(white)%s%Creset %C(magenta)[%an]%Creset %C(yellow)%d%Creset %C(cyan)(%ad UTC)%Creset" --date=format-local:%Y-%m-%dT%H:%M:%SZ'
